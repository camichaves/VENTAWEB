...
import venta.config.audit.AuditEventConverter;
import venta.domain.PersistentAuditEvent;
...
import static venta.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
